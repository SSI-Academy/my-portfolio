    ...
    <div className="bg-gray-900 text-gray-100 font-open-sans min-h-screen">
      ...
      <section id="about" className="py-24 px-6 bg-gray-800">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-6 font-open-sans">
            I&apos;m a dedicated web developer with a keen eye for design and
            user experience. My journey in web development began with a
            fascination for how digital products can solve real-world problems
          ...
          <p className="text-xl text-gray-300 leading-relaxed font-open-sans">
            ...
            Tailwind CSS, I strive to build robust, scalable, and aesthetically
            pleasing applications. I believe in clean code, efficient workflows,
            and continuous learning to stay ahead in the ever-evolving tech
            landscape.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <div className="bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex-1 min-w-[280px] max-w-[400px]">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <span className="bg-gray-700 text-gray-200 px-4 py-2 rounded-full text-lg font-medium border border-gray-600 flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-gray-800 rounded-lg shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-4 font-open-sans">
                  A full-stack e-commerce solution with secure payment
                  integration and a responsive design.
                </p>
                <a
                  href="#"
            ...
            <div className="bg-gray-800 rounded-lg shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-4 font-open-sans">
                  An intuitive task management application with real-time
            ...
            <div className="bg-gray-800 rounded-lg shadow-xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-4 font-open-sans">
                  A responsive and modern personal portfolio website showcasing
      ...
      <footer className="bg-gray-950 text-gray-500 py-8 text-center text-sm font-open-sans">
        <div className="container mx-auto px-6">
          ...
          <p className="mt-2">
            Designed and Developed with &#x2764;&#xfe0f; and Next.js
          </p>
        </div>
      </footer>
    </div>
